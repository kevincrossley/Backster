function [euler] = ExScriptFun(senX,sampleRate,Beta)
%
...
% load('Accelerometer7.mat');
% load('Magnetometer7.mat');
% load('Gyroscope7.mat');
% load('time7.mat');
% Magnetometer = pt3;
% Accelerometer = Accelerometer./9.81;
% 
% Accelerometer = Accelerometer(200:400,:);
% Magnetometer = Magnetometer(200:400,:);
% Gyroscope = Gyroscope(200:400,:);
% time = time(200:400,:);

time = senX(:,1);
Accelerometer = senX(:,2:4);
Gyroscope = senX(:,5:7);
Magnetometer = senX(:,8:10);

% figure('Name', 'Sensor Data');
% axis(1) = subplot(3,1,1);
% hold on;
% plot(time, Gyroscope(:,1), 'r');
% plot(time, Gyroscope(:,2), 'k');
...
AHRS = MadgwickAHRS('SamplePeriod', sampleRate, 'Beta', Beta);
